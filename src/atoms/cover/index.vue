<template>
            ...
            <div>
              ...
              <div>
                ...
                <div class="mt-8 flex gap-x-4 sm:justify-center">
                  <nuxt-link to="/install" class="inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700">
                    Get started
                   <!--  <span class="text-indigo-200" aria-hidden="true">&rarr;</span> -->
                  </nuxt-link>
                  <nuxt-link to="/features" class="inline-block rounded-lg px-4 py-1.5 text-base font-semibold leading-7 text-gray-900 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                    Browse features
  ...
  const navigation =  routes.map(({ name, path }) => ({
    name,
    href: path
  }))
