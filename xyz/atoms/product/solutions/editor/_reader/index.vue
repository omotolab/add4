...
div
        .uk-panel
            part.uk-card-small
                ...
                ).uk-overflow-auto.uk-width-xlarge.uk-card-body.uk-padding-remove-vertical.uk-overflow-auto
        .uk-panel
            part(
                :title="'action'"
                :actions="true"
...
export default {
    ...
    async asyncData({ $content, params, query }) {
      const contentPath = params['tm']
      const items = await $content(contentPath)
