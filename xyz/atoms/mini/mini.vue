  ...
  section.uk-section-small
    .uk-container
      article(class='uk-width-2-3@m')
        h2.uk-h2 {{title}}
        p {{description}}
        a.uk-button.uk-border-pill {{action}}
  section.uk-section-small
    .uk-container
      h3.uk-h3 Features
      article(class='uk-child-width-1-2@m' uk-grid='' uk-height-match="target: > div > .uk-card") 
        div(v-for="feature in features")
          .uk-card.uk-card-default.uk-card-large
            .uk-card-media-top
              img(:src='feature.image').uk-width-expand.uk-border-rounded
            .uk-card-body
              h3.uk-h4.uk-card-title {{feature.title}}
              p {{feature.description}}  
  section.uk-section-small
    .uk-container
      h3.uk-h3 Benefits
      article(class='uk-child-width-1-3@m' uk-grid='' uk-height-match="target: > div > .uk-card")
        div(v-for="benefit in benefits")
          .uk-card.uk-card-default
            .uk-card-media-top.uk-cover-container
              img(:src='benefit.image' uk-img).uk-width-expand.uk-border-rounded
              .uk-overlay.uk-light.uk-position-bottom
                h3.uk-h3.uk-card-title {{benefit.title}}
            .uk-card-body
