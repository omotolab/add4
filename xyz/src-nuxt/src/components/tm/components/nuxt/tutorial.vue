...
export default {
  ...
  props: {
    ...
    description: {
      type: String,
      default: () => "We recommend you take a look at the [Nuxt documentation](https://nuxtjs.org){:target='_blank'}, whether you are new or have previous experience with the framework."
    },
    instruction: {
      type: String,
      default: () => "To get started, remove `components/Tutorial.vue`, and start coding in `pages/index.vue`. Have fun!"
    },
    links: [
      {
        icon: 'github'
