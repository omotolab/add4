      ...
      <Group :rotation="{ x: -Math.PI / 2, y: 0, z: 0 }">
        ...
        <Plane :width="30" :height="30" :rotation="{ x: 0 }" :position="{ z: -3 }">
          <StandardMaterial :props="{ displacementScale: 0.2, roughness: 0, metalness: 0 }">
            ...
            <Texture :props="texturesProps" src="/assets/textures/Wood_Tiles_002_normal.jpeg" name="normalMap" />
            <Texture :props="texturesProps" src="/assets/textures/Wood_Tiles_002_roughness.jpeg" name="roughnessMap" />
            <Texture :props="texturesProps" src="/assets/textures/Wood_Tiles_002_ambientOcclusion.jpeg" name="aoMap" />
          </StandardMaterial>
        </Plane>
      </Group>
    </Scene>
