const GITHUB_CLIENT_ID=`Iv1.6db9fb8675f0c8cd`
const GITHUB_CLIENT_SECRET=`a059017c8b158e5bfc6acd28263a61f0d6069aea`
 ...
 ******************************************************************************/
    ...
    /* https: {
      key: require("fs").readFileSync('./Volumes/-.-/OmotoLab/add4/xyz/server/config/localhost-key.pem'),
      cert: require("fs").readFileSync('./Volumes/-.-/OmotoLab/add4/xyz/server/config/localhost.pem')
    }, */
 ...
 ******************************************************************************/
     ...
     */
    httpStatic: './dist', //single static source
