const getDocument = ({ title }) => {
  const index = {
    'System Operations Setup': {
      label: 'System Operations Setup',
      schema: [
        {
          $el: 'h1',
          children: 'System Operations Setup'
        },
        {
          $cmp: 'FormKit',
          props: {
          ...
          children: [
            {
              ...
              children: [
                {
                  $el: 'em',
                  children: '*All the contents of this form are fictional (the company, grant, and form) for the purposes of demonstrating the capabilities of FormKit.'
                }
              ]
            }
          ]
      ...
      'schema': [
        {
          $el: 'h1',
          attrs: {
            class: 'uk-h5 uk-card uk-card-default'
          },
          children: 'Login'
        },
      ]
...
export default function useStructures({ title }) {
